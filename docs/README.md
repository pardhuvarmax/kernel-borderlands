...
Defines the event contract between kb-core and kb-control-plane, including the locked set of `event_type` values and the metadata key conventions for each event type. This serves as the integration reference for any component producing or consuming kb-core telemetry.
...
### `docs/project/KB_Synopsis-1.pdf`
