...
3. **[June 26 Status Report](../../reports/kb-control-plane/june26-26.md)**: Historical development updates. (Lives under `docs/reports/kb-control-plane/`, not this directory.)
